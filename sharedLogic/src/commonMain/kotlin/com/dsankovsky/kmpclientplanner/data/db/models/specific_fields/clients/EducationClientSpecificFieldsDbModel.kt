...
@Entity(
    tableName = "education_client_specific_fields",
    foreignKeys = [
        ForeignKey(
            entity = BaseClientDbModel::class,
            parentColumns = arrayOf(BaseClientDbModel.Companion.NAME_ID),
            childColumns = arrayOf(EducationClientSpecificFieldsDbModel.NAME_CLIENT_ID),
            onDelete = ForeignKey.CASCADE
        )
    ]
)
data class EducationClientSpecificFieldsDbModel(
