...
package com.dsankovsky.kmpclientplanner.extensions
...
//fun getDaysOfWeekList(): List<LocalizedDayOfWeek> = LocalizedDayOfWeek.entries
fun getDayOfWeek(date: LocalDate): DayOfWeek =
    DayOfWeek.entries.first { it == date.dayOfWeek }

fun getDayOfWeek(isoIndex: Int): DayOfWeek =
    DayOfWeek.entries.first { it.isoDayNumber == isoIndex }
...
fun getMonth(date: LocalDate): Month =
    Month.entries.first { it == date.month }
